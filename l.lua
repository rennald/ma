...
--Moonic Glitcher V11 (unofficial)--
--made by TrixLua#8210--
--edited by Magnavium#7968--
--this is a Public Glitcher--
--THE ZEON FAILED. NOW U MEET THE SUCCESSOR. MOON...--

local say = "Made by TrixLua, edited by Magnavium"
if not e then
...
local say = "CREDITS TO SWORD, NEVER, BRUH, TRIXLUA, KINGSTON,  FOR MAKING THIS GLITCHER POSSIBLE (I may forgot others)"
if not e then
game.StarterGui:SetCore("ChatMakeSystemMessage", {
Text = say;
Font = Enum.Font.Cartoon;
...
zeontag.Text = "Ultimus Glitcher V4"
...
creditmelolol.Text = "By TrixLua/Golden exploits and Magnavium"
...
local modeInfo={
	...
	{Name="GASTER",Walkspeed=18,moveVal=9,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,255,255);Music=613035749,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='StarGASTER'};
	...
	{Name="FREEZING",Walkspeed=50,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.N(255,255,255);Music=864793052,LeftWing={0,BrickColor.new'Cyan'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Cyan'.Color,Enum.Material.Neon};WingAnim='CERTUS1'};
	{Name="AFTERLIFE",Walkspeed=50,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.5,.5,.5);Music=2035904986,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Cyan'.Color,Enum.Material.Neon};WingAnim='StarLTT'};
	...
	{Name="GL^%£ITCH",Walkspeed=50,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.5,.5,.5);Music=1747451164,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='StarGLITCH'};
	...
	{Name="ANTIMATTER",Walkspeed=46,moveVal=13,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.5,.5,.500);Music=4272705694,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarELE'};
	{Name="THE FORGOTTEN",Walkspeed=46,moveVal=13,Font=Enum.Font.Fantasy,StrokeColor=C3.N(0,0,0);Music=395381956,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarLTER'};
	...
	{Name="Pheonix",Walkspeed=69,moveVal=13,Font=Enum.Font.Fantasy,StrokeColor=C3.N(255,255,255);Music=1276814239,LeftWing={0,BrickColor.new'Gold'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Gold'.Color,Enum.Material.Neon};WingAnim='StarB'};
	{Name="CRYPTO",Walkspeed=46,moveVal=13,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.5,.5,.500);Music=366948782,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Neon};WingAnim='StarTER'};
	...
	{Name="HYPNOSIS",Walkspeed=90,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.6,.0,.9);Music=873042302,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};WingAnim={'StarLOXD'}};
	...
	{Name="PRISM",Walkspeed=71,moveVal=9,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=2272275958,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Brick};WingAnim='MANGYR'};
	...
	{Name="SPACETIME X",Walkspeed=120,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,255,255);Music=142720946,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};WingAnim='Sonar2',0.1};
	{Name="CRUELTY",Walkspeed=120,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.6,.0,.9);Music=723652641,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};WingAnim='StarLG'};
	{Name="Galactic",Walkspeed=16,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.6,.0,.9);Music=5410081112,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};WingAnim='SONUS5'};
	...
	{Name="GALACTIC",Walkspeed=48,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.N(0,0,0);Music=305425343,LeftWing={0,BrickColor.new'Magenta'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Magenta'.Color,Enum.Material.Glass};WingAnim='SONUS3'};
	{Name="COSMIC",Walkspeed=56,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.N(255,255,255);Music=3254997454,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};WingAnim='SONUS3B'};
	{Name="ENTITY X",Walkspeed=67,moveVal=8,Font=Enum.Font.Garamond,StrokeColor=C3.N(.1,.1,.1);Music=225168894,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};WingAnim={'INSANEGREG2',2}};
	...
	{Name="BROKEN MACHINERY",Walkspeed=16,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.RGB(98,37,209);Music=603291385,LeftWing={0,BrickColor.new'Dark indigo'.Color,Enum.Material.DiamondPlate};RightWing={0,BrickColor.new'Dark indigo'.Color,Enum.Material.DiamondPlate};WingAnim='MANGYRT'};
	...
	{Name="ACE OF SPADES",Walkspeed=67,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.N(255,.9,0);Music=2561705325,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Dark stone grey'.Color,Enum.Material.Glass};WingAnim='NebJEVIL'};
	...
	{Name="HEROIC",Walkspeed=37,moveVal=20,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,0,220);Music=835120625,LeftWing={0,BrickColor.new'Gold'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Gold'.Color,Enum.Material.Neon};WingAnim='StarLG'};
	{Name="ARCHANGEL",Walkspeed=90,moveVal=5,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(249,214,46);Music=1881326122,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Fire Yellow'.Color,Enum.Material.Neon};WingAnim='Crazed'};
	...
	{Name="Reanimate",Walkspeed=64,moveVal=14,Font=Enum.Font.Jura,StrokeColor=C3.RGB(255,255,255);Music=6914185827,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};WingAnim='StarLFR1'};
	{Name="Inverse Reanimate",Walkspeed=64,moveVal=14,Font=Enum.Font.Jura,StrokeColor=C3.RGB(0,0,0);Music=6914227002,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='StarLFR2'};
	{Name="Dual Reanimate",Walkspeed=128,moveVal=14,Font=Enum.Font.Jura,StrokeColor=C3.RGB(0,0,0);Music=7133611438,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};WingAnim='StarLFR3'};
	...
	{Name="HERALD OF ILLUSION",Walkspeed=66,moveVal=15,Font=Enum.Font.Jura,StrokeColor=C3.RGB(0,0,0);Music=1836762394,LeftWing={0,BrickColor.new'Earth green'.Color,Enum.Material.DiamondPlate};RightWing={0,BrickColor.new'White'.Color,Enum.Material.DiamondPlate};WingAnim={'really'}};
	--MAJORS--
	...
	{Name="INFERNAL",Walkspeed=50,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.RGB(255,152,220);Music=1609011649,LeftWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='StarLEP'};
	{Name="N U C L E A R",Walkspeed=64,moveVal=9,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(0,255,0);Music=798163149,LeftWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Neon};WingAnim='StarLE1'};
	{Name="N U C L E A R  X",Walkspeed=64,moveVal=9,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(0,255,0);Music=798163149,LeftWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Neon};WingAnim='StarLE'};
	...
	{Name="CRANKTON",Walkspeed=64,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.N(255,.9,0);Music=145897653,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Dark stone grey'.Color,Enum.Material.Glass};WingAnim={'StarBR'}};
	...
	{Name="ILLUMINATION",Walkspeed=35,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.N(255,255,255);Music=3055769970,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Neon};WingAnim='StarTE', 20};
   	...
   	{Name="ETERNAL LIGHT",Walkspeed=200,moveVal=15,Font=Enum.Font.Gotham,StrokddeColor=C3.RGB(98,37,209);Music=2726143421,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.DiamondPlate};RightWing={0,BrickColor.new'White'.Color,Enum.Material.DiamondPlate};WingAnim='SONUS2'};
	...
	{Name="FEARLESS",Walkspeed=100,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.N(0,0,0);Music=1339865767,LeftWing={0,BrickColor.new'Dark blue'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Dark blue'.Color,Enum.Material.Neon};WingAnim='FEARLESS'};
	{Name="CYBERPUNK",Walkspeed=46,moveVal=13,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(4,175,236);Music=6191997760,LeftWing={0,BrickColor.new'New Yeller'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Hot pink'.Color,Enum.Material.Neon};WingAnim='PUNK'};
	{Name="THE PLAGUEBRINGER",Walkspeed=186,moveVal=15,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(0,255,0);Music=5567767035,LeftWing={0,BrickColor.new'Earth green'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Earth green'.Color,Enum.Material.Neon};WingAnim={'Palactus'}};
	{Name="HELLSTORM",Walkspeed=66,moveVal=8,Font=Enum.Font.Garamond,StrokeColor=C3.RGB(255,25,25);Music=1838627204,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Neon};WingAnim='Hell2'};
	{Name="INFERNO",Walkspeed=67,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.RGB(255,152,220);Music=1609011649,LeftWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='NebCALAMITAS1'};
	{Name="SHATTERED X",Walkspeed=90,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=4755976868,LeftWing={0,BrickColor.new'Dark indigo'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Alder'.Color,Enum.Material.Neon};WingAnim='SHATTERX'};
	...
	{Name="SOLITUDE",Walkspeed=64,moveVal=8,Font=Enum.Font.Garamond,StrokeColor=C3.RGB(255,255,255);Music=5013876933,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='StarLOXD1'};
	{Name="NIRMITI",Walkspeed=64,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.RGB(249,214,46);Music=6064179167,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Fire Yellow'.Color,Enum.Material.Neon};WingAnim='StarLTT1'};
	{Name="ELEGANCE",Walkspeed=20,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.RGB(232,186,200);Music=2681692912,LeftWing={0,BrickColor.new'Institutional white'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Institutional white'.Color,Enum.Material.Neon};WingAnim='TASTEMYSWORDS2'};
	{Name="DEVASTATION",Walkspeed=66,moveVal=8,Font=Enum.Font.Jura,StrokeColor=C3.RGB(255,25,25);Music=911332127,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Neon};WingAnim='NebCALAMITASsmol'};
	{Name="X-TRON",Walkspeed=64,moveVal=20,Font=Enum.Font.Fantasy,StrokeColor=C3.RGB(4,175,236);Music=277564373,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Dark stone grey'.Color,Enum.Material.Glass};WingAnim={'StarXD',10}};
	{Name="DESTRUCTION",Walkspeed=60,moveVal=8,Font=Enum.Font.Bodoni,StrokeColor=C3.RGB(150,0,0);Music=4615964997,LeftWing={0,BrickColor.new'Maroon'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Maroon'.Color,Enum.Material.Neon};WingAnim='DESTRUCTION'};
	{Name="DESTRUCTION X",Walkspeed=186,moveVal=8,Font=Enum.Font.Jura,StrokeColor=C3.N(.6,.0,.9);Music=6916155480,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Neon};WingAnim='GALACTUSA'};	
	...
	{Name="ULTRABASS",Walkspeed=67,moveVal=15,Font=Enum.Font.Bangers,StrokeColor=C3.N(255,255,255);Music=4513235241,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};WingAnim='RushALL'};
	{Name="DOOMSDAY",Walkspeed=18,moveVal=9,Font=Enum.Font.Fantasy,StrokeColor=C3.RGB(0,255,0);Music=2116461106,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarLEP1'};
    {Name="+OVERPOWERED+",Walkspeed=64,moveVal=15,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(0,190,190);Music=3330414980,LeftWing={0,BrickColor.new'Pastel light blue'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Pastel light blue'.Color,Enum.Material.Glass};WingAnim='TSI1'};	
	{Name="disfigured",Walkspeed=66,moveVal=8,Font=Enum.Font.Antique,StrokeColor=C3.RGB(151,0,0);Music=4615932760,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};WingAnim='HOWDOIDOTHIS'};
	{Name="besmirch",Walkspeed=66,moveVal=8,Font=Enum.Font.Antique,StrokeColor=C3.RGB(226,155,64);Music=3255006996,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};WingAnim='besmirch'};
	{Name="VORTEX",Walkspeed=186,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.N(255,.9,0);Music=4590629941,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Dark stone grey'.Color,Enum.Material.Glass};WingAnim={'GALACTUS'}};
	{Name="HURRICANE",Walkspeed=66,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.RGB(255,255,255);Music=3697636559,LeftWing={0,BrickColor.new'Medium stone grey'.Color,Enum.Material.DiamondPlate};RightWing={0,BrickColor.new'Medium stone grey'.Color,Enum.Material.Neon};WingAnim='THESTORM'};
}
...
local RWP8 = WingPiece:Clone();
if game.Players.LocalPlayer.Character:FindFirstChild("FiveKingdomsHelmet") then -- FiveKingdomsHelmet
	for _,v in pairs(RWP8:GetChildren()) do
		if v:IsA("BasePart") then
			v.Transparency = 1
		end
	end
	local athp = Instance.new("Attachment",RWP8.PrimaryPart)
	local atho = Instance.new("Attachment",RWP8.PrimaryPart)

	local HatChoice = game.Players.LocalPlayer.Character:FindFirstChild("FiveKingdomsHelmet") --divine Aura
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho
...
local RWP8W=Weld(RWP8.PrimaryPart,Head,CF.N(0,0,0)*CF.A(0,0,M.R(0)))
...
function syncStuff(data)
	...
	if(Mode=='TRIX-LUA' and music.SoundId~='rbxassetid://'..visSett.Music)then
		music.SoundId='rbxassetid://'..visSett.Music
	end
	getMode('TRIX-LUA').Music = visSett.Music
	getMode('TRIX-LUA').Pitch = visSett.Pitch
end
	...
	--if(game.PlaceId ~= 843468296)then
		coroutine.wrap(function()
			...
			for i = 1, #text do
				...
				Txt.TextColor3=(Mode=='TRIX-LUA' and Color3.fromHSV(hue/360,1,math.clamp(music.PlaybackLoudness/475,0,1)) or PrimaryColor)
				if(vaporwaveMode and Mode=='TRIX-LUA')then
					Txt.Text = Vaporwaveify(text:sub(1,i))
				else
...
function Click1()
	...
	for i = 0, 1, 0.1 do
		...
		AOEDamage(RArm.CFrame.p,2,{
			DamageColor=(Mode=='TRIX-LUA' and C3.HSV(hue/360,1,math.clamp(music.PlaybackLoudness/475,0,1)) or PrimaryColor);
			MinimumDamage=5;
			MaximumDamage=15;
		})
		local Alpha = .3
...
function VaporFUCK()
	...
	for i = 0, 5, 0.1 do
		swait()
		local Alpha = .1
	    RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,2+.6*M.C(Sine/39),-0)*CF.A(M.R(-2+5*M.S(Sine/32)),M.R(20+5*M.C(Sine/24)),0),Alpha)
...
function VaporFUCK2()
	...
	for i = 0, 5, 0.1 do
		swait()
		local Alpha = .1
	    RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,13+.6*M.C(Sine/39),-0)*CF.A(M.R(-2+5*M.S(Sine/32)),M.R(20+5*M.C(Sine/24)),0),Alpha)
		LH.C0 = LH.C0:lerp(CF.N(-0.5,-1,0)*CF.A(M.R(90+7.5*M.S(Sine/24)),M.R(19.2),M.R(-5.7)),Alpha)
	    RH.C0 = RH.C0:lerp(CF.N(0.4,.3,-0.8)*CF.A(M.R(30+3.5*M.S(Sine/24)),M.R(-15),M.R(8.3)),Alpha)
		LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.2*M.S(Sine/52),0)*CF.A(0,M.R(5+5*M.C(Sine/52)),M.R(-160-15*M.C(Sine/62))),Alpha)
		RS.C0 = RS.C0:lerp(RSC0*CF.N(-0,0+.2*M.S(Sine/52),-0)*CF.A(0,M.R(5-5*M.C(Sine/52)),M.R(160+15*M.C(Sine/62))),Alpha)
	...
	for i = 0, 1, 0.1 do
		swait()
		local Alpha = .3
		RJ.C0 = RJ.C0:lerp(CF.N(0,25,0.7)*CF.A(M.R(18.2),M.R(0),M.R(0)),Alpha)
		LH.C0 = LH.C0:lerp(CF.N(-0.5,-1.1,-0.4)*CF.A(M.R(-33.4),M.R(0),M.R(0)),Alpha)
		RH.C0 = RH.C0:lerp(CF.N(0.5,-0.9,-0.2)*CF.A(M.R(-6.7),M.R(0),M.R(0)),Alpha)
		LS.C0 = LS.C0:lerp(CF.N(-1.4,0.4,0.1)*CF.A(M.R(90.7),M.R(-2.5),M.R(-50)),Alpha)
		RS.C0 = RS.C0:lerp(CF.N(1.4,0.5,0.2)*CF.A(M.R(89.5),M.R(2.6),M.R(50)),Alpha)
...
function EleganceSmash()
	...
	for i = 0, 5, 0.1 do
		swait()
		local Alpha = .1
	    RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,0+.05*M.C(Sine/32),0)*CF.A(M.R(-2+1*M.S(Sine/64)),M.R(-25),0),Alpha)
		LH.C0 = LH.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(M.R(-4),0,M.R(-12)),Alpha)
		RH.C0 = RH.C0:lerp(RHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(M.R(4),0,M.R(12)),Alpha)
	...
	coroutine.wrap(function()
		for i = 0, 5 do
			...
			SoundPart(7681928375,.8,4,false,true,true,Root.CFrame*CF.N(0,0,-4-i*4))
			AOEDamage(Root.CFrame*CF.N(0,0,-4-i*4).p,5,{
				DamageColor=PrimaryColor;
				MinimumDamage=25;
				MaximumDamage=45;
...
function VaporHI()
	...
	for i = 0, 5, 0.1 do
		swait()
		local Alpha = .1
		RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,2+.4*M.C(Sine/39),-0)*CF.A(M.R(-2+5*M.S(Sine/32)),M.R(20+5*M.C(Sine/24)),0),Alpha)
...
local search = "just look up the word search to find the voicelines"
	...
	elseif Mode == "CRUELTY" then Chat"Its Over for you..."
	elseif Mode == "Trinity Keeper" then Chat"PROTECT THE TRINITY"
	elseif Mode == "ZEN-X" then Chat"You can run. but you cant hide..."
	elseif Mode == "ZORNO" then Chat"You cant hide CRANKTON. I will find you."
	elseif Mode == "CRANKTON" then Chat"ZORNO... you are going to regret that..."
	elseif Mode == "ARCHANGEL" then Chat "I am the guardian of earth and heaven."
	...
	elseif Mode == "GL^%£ITCH" then Chat "its not over yet"
	...
	elseif Mode == "SHATTERED" then Chat "SHATTER!"
	elseif Mode == "HURRICANE" then Chat "I AM THE STORM"
...
UIS.InputBegan:connect(function(io,gpe)
	...
	elseif(io.KeyCode == Enum.KeyCode.Two and Mode~='=_-Humane-_=')then 
		changeMode'=_-Humane-_='  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='=_-Humane-_=')then 
		changeMode'ELEGANCE'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='ELEGANCE')then 
	    EleganceSmash() 
	elseif(io.KeyCode == Enum.KeyCode.Three and Mode~='CRUELTY')then
		changeMode'CRUELTY' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.P and Mode~='SPACETIME X')then 
		changeMode'SPACETIME X'  game.lighting.ClockTime = 0 game.Lighting.FogEnd = 9999
	elseif(io.KeyCode == Enum.KeyCode.G and Mode~='GL^%£ITCH')then
		changeMode'GL^%£ITCH' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.Five and Mode~='INFINITY')then
		changeMode'INFINITY'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.Seven and Mode~='TRIX-LUA')then
		changeMode'TRIX-LUA' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='TRIX-LUA')then
		changeMode'C a r' game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
elseif(io.KeyCode == Enum.KeyCode.F and Mode=='CRUELTY')then 
        CrueltiesSmash()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
elseif(io.KeyCode == Enum.KeyCode.F and Mode=='SHATTERED')then 
        CrueltiesSmash2()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
elseif(io.KeyCode == Enum.KeyCode.R and Mode=='SHATTERED')then 
        VaporFUCK()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
elseif(io.KeyCode == Enum.KeyCode.R and Mode=='SHATTERED X')then 
        VaporFUCK2()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.K and Mode~='ZEN-X')then
		...
		elseif(io.KeyCode == Enum.KeyCode.J and Mode~='HEROIC')then 
		changeMode'HEROIC'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.Y and Mode~='Pheonix')then 
		changeMode'Pheonix'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='LEGMAN')then
	...
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='AURORA')then
		changeMode'Reanimate' game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.U and Mode=='Reanimate')then
		changeMode'DESTRUCTION X' game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Sadness')then 
	...
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='PURIFIED')then 
		changeMode'CRANKTON' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='CRUELTY')then 
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='GL^%£ITCH')then 
		changeMode'FREEZING' VaporTaunt() game.lighting.ClockTime = 0 game.Lighting.FogEnd = 150
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='GL^%£ITCH')then 
	    changeMode'AFTERLIFE' game.lighting.ClockTime = 0 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='AFTERLIFE')then 
	    changeMode'SOLITUDE' game.lighting.ClockTime = 0 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='AFTERLIFE')then 
	    changeMode'NIRMITI' game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.Q and Mode=='Dark Energy')then 
	...
	elseif(io.KeyCode == Enum.KeyCode.C and Mode=='PRISM')then
		changeMode'ACE OF SPADES' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='=_-Humane-_=')then 
		changeMode'=_-MADNESS-_='  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.U and Mode=='Time')then 
		changeMode'HURRICANE' VaporTaunt() game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='Pheonix')then 
		changeMode'Hardbass'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='AFTERLIFE')then 
		changeMode'disfigured'  game.lighting.ClockTime = 7 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='Hardbass')then 
		changeMode'ULTRABASS'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='ULTRABASS')then 
		changeMode'Hardbass'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='Time')then 
		changeMode'ANTIMATTER' game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='Time')then 
		changeMode'~Funky~' game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='Sadness')then 
		changeMode'The Big Black'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='Sadness')then 
		changeMode'DEVASTATION'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='Sadness')then 
	...
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='besmirch')then 
		changeMode'VORTEX'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='BROKEN MACHINERY')then
		changeMode'ETERNAL DARKNESS'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='The Doctor')then 
		changeMode'HYPNOSIS' VaporTaunt()   game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='HYPNOSIS')then 
		changeMode'HERALD OF ILLUSION' VaporTaunt()   game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='HERALD OF ILLUSION')then 
		changeMode'HYPNOSIS' VaporTaunt()   game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='The Doctor')then 
		changeMode'RIDDLER'   game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='ETERNAL DARKNESS')then
		changeMode'ETERNAL LIGHT'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.C and Mode=='Dark Energy')then
		changeMode'Mayhem'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='N U C L E A R')then
		changeMode'DOOMSDAY'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.V and Mode=='N U C L E A R')then
		changeMode'N U C L E A R  X'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
		elseif(io.KeyCode == Enum.KeyCode.V and Mode=='N U C L E A R  X')then
		changeMode'N U C L E A R'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='N U C L E A R')then
		changeMode'THE PLAGUEBRINGER'  game.lighting.ClockTime = 2 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='SYNCHRO')then 
		changeMode'OVERKILL'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='THE END OF WORLDS')then 
		changeMode'PESTILENCE' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='THE END OF WORLDS')then 
		EndofworldsSMASHDOWN() VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='SANS')then 
		changeMode'GASTER' game.lighting.ClockTime = 0 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='Broken PR0GRam')then 
		changeMode'X-TRON' game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='UNBROKEN')then 
		changeMode'+OVERPOWERED+' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='ULTRAVIOLET')then 
		changeMode'CRYPTO' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='CRYPTO')then 
		changeMode'CYBERPUNK' VaporTaunt()  game.lighting.ClockTime = 0 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='PRISM')then 
		changeMode'FORCE' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='HyPnOtIC')then 
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='INFINITY')then 
		changeMode'ENTITY X' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='INFINITY')then 
		changeMode'WAR MACHINE' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='UNBROKEN')then 
		changeMode'NEPTUNIAN V (UNEQUIPPED)'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='BLOODWATER')then 
		changeMode'HELLSTORM' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='PARADOX')then 
		changeMode'SHATTERED' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='SHATTERED')then 
		changeMode'SHATTERED X' VaporTaunt()  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='GALACTIC')then 
		changeMode'COSMIC' VaporTaunt()   game.lighting.ClockTime = 0 game.Lighting.FogEnd = 999999999999
    elseif(io.KeyCode == Enum.KeyCode.E and Mode=='GALACTIC')then 
		changeMode'FEARLESS' VaporTaunt()   game.lighting.ClockTime = 0 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='GALACTIC')then 
		changeMode'INFERNO' VaporTaunt()   game.lighting.ClockTime = 6 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='NEPTUNIAN V (UNEQUIPPED)')then 
		changeMode'NEPTUNIAN V'  game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='FREEZING')then 
		changeMode'INFERNAL'  game.lighting.ClockTime = 0 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='CRUELTY')then
		changeMode'PARADOX' VaporTaunt()   game.lighting.ClockTime = 0 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='AURORA')then 
		changeMode'Trinity Keeper' VaporTaunt() game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='The Doctor')then 
		changeMode'Reanimate' VaporTaunt() game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='Reanimate')then 
		changeMode'Inverse Reanimate' VaporTaunt() game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='Inverse Reanimate')then 
		changeMode'Reanimate' VaporTaunt() game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Inverse Reanimate')then 
		changeMode'Dual Reanimate' VaporTaunt() game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Reanimate')then 
		changeMode'Dual Reanimate' VaporTaunt() game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='Dual Reanimate')then 
		changeMode'Reanimate' VaporTaunt() game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='PRISM')then 
		changeMode'ARCHANGEL'  VaporTaunt()   game.lighting.ClockTime = 14 game.Lighting.FogEnd = 999999999999
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='AURORA')then
		changeMode'The Doctor' VaporTaunt()
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='The Doctor')then
		changeMode'ILLUMINATION' VaporTaunt()
	--TOGGLE MUSIC
...
local wbutton2 = Instance.new("TextButton")
local obutton2 = Instance.new("TextButton")
local ybutton2 = Instance.new("TextButton")
local ibutton2 = Instance.new("TextButton")
local bbutton2 = Instance.new("TextButton")
local mbutton2 = Instance.new("TextButton")
local nbutton2 = Instance.new("TextButton")
local isskidbutton2 = Instance.new("TextButton")
local krewbest2 = Instance.new("TextButton")
local eisskid2 = Instance.new("TextButton")
local oisskid2 = Instance.new("TextButton")
...
creator.Size = UDim2.new(0, 131, 0, 42)
creator.Font = Enum.Font.SourceSans
creator.Text = ""
creator.TextColor3 = Color3.fromRGB(8271, 40, 0)
...
title.Size = UDim2.new(0, 181, 0, 42)
title.Font = Enum.Font.SciFi
title.Text = ""
title.TextColor3 = Color3.fromRGB(9872, 20, 4)
...
obutton.Name = "tbutton"
obutton.Parent = epic
obutton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
obutton.Position = UDim2.new(0, 0, 0, 0)
obutton.Size = UDim2.new(0, 30, 0, 22)
obutton.Font = Enum.Font.SourceSans
obutton.Text = "1st"
obutton.TextColor3 = Color3.fromRGB(0, 0, 0)
obutton.TextSize = 10.000
...
tbutton.Position = UDim2.new(0.3, 0, 0, 0)
tbutton.Size = UDim2.new(0, 30, 0, 22)
tbutton.Font = Enum.Font.SourceSans
tbutton.Text = "4th"
tbutton.TextColor3 = Color3.fromRGB(0, 0, 0)
tbutton.TextSize = 10.000
tbutton.MouseButton1Down:connect(function()
   changeMode'LOSS'()
end)

ibutton.Name = "ebutton"
ibutton.Parent = epic
ibutton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
ibutton.Position = UDim2.new(0.2, 0, 0.2, 0)
ibutton.Size = UDim2.new(0, 30, 0, 22)
ibutton.Font = Enum.Font.SourceSans
ibutton.Text = "10th"
ibutton.TextColor3 = Color3.fromRGB(0, 0, 0)
ibutton.TextSize = 10.000
ibutton.MouseButton1Down:connect(function()
   changeMode'THE PLAGUEBRINGER'()
end)

mbutton.Name = "ebutton"
mbutton.Parent = epic
mbutton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
mbutton.Position = UDim2.new(0.3, 0, 0.2, 0)
mbutton.Size = UDim2.new(0, 30, 0, 22)
mbutton.Font = Enum.Font.SourceSans
mbutton.Text = "11th"
mbutton.TextColor3 = Color3.fromRGB(0, 0, 0)
mbutton.TextSize = 10.000
mbutton.MouseButton1Down:connect(function()
   changeMode'N U C L E A R'()
end)

nbutton.Name = "ebutton"
nbutton.Parent = epic
nbutton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
nbutton.Position = UDim2.new(0.4, 0, 0.2, 0)
nbutton.Size = UDim2.new(0, 30, 0, 22)
nbutton.Font = Enum.Font.SourceSans
nbutton.Text = "12th"
nbutton.TextColor3 = Color3.fromRGB(0, 0, 0)
nbutton.TextSize = 10.000
nbutton.MouseButton1Down:connect(function()
   changeMode'N U C L E A R  X'()
end)

ybutton.Name = "ebutton"
ybutton.Parent = epic
ybutton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
ybutton.Position = UDim2.new(0.1, 0, 0.2, 0)
ybutton.Size = UDim2.new(0, 30, 0, 22)
ybutton.Font = Enum.Font.SourceSans
ybutton.Text = "9th"
ybutton.TextColor3 = Color3.fromRGB(0, 0, 0)
ybutton.TextSize = 10.000
ybutton.MouseButton1Down:connect(function()
   changeMode'DOOMSDAY'()
end)

bbutton.Name = "ebutton"
bbutton.Parent = epic
bbutton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
bbutton.Position = UDim2.new(0.1, 0, 0, 0)
bbutton.Size = UDim2.new(0, 30, 0, 22)
bbutton.Font = Enum.Font.SourceSans
bbutton.Text = "2nd"
bbutton.TextColor3 = Color3.fromRGB(0, 0, 0)
bbutton.TextSize = 10.000
bbutton.MouseButton1Down:connect(function()
   changeMode'Mayhem'()
end)

isskidbutton.Name = "ebutton"
isskidbutton.Parent = epic
isskidbutton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
isskidbutton.Position = UDim2.new(0.5, 0, 0.2, 0)
isskidbutton.Size = UDim2.new(0, 30, 0, 22)
isskidbutton.Font = Enum.Font.SourceSans
isskidbutton.Text = "13th"
isskidbutton.TextColor3 = Color3.fromRGB(0, 0, 0)
isskidbutton.TextSize = 10.000
isskidbutton.MouseButton1Down:connect(function()
   changeMode'ETERNAL LIGHT'()
end)

krewbest.Name = "ebutton"
krewbest.Parent = epic
krewbest.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
krewbest.Position = UDim2.new(0.6, 0, 0.2, 0)
krewbest.Size = UDim2.new(0, 30, 0, 22)
krewbest.Font = Enum.Font.SourceSans
krewbest.Text = "14th"
krewbest.TextColor3 = Color3.fromRGB(0, 0, 0)
krewbest.TextSize = 10.000
krewbest.MouseButton1Down:connect(function()
   changeMode'C a r'()
end)
...
WingAnims.StarGRE=function()
	...
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(12.20,5,1)*CF.A(M.R(15-2000*M.C(WingSine/92)),0,M.R(45+9*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-12.20,5,-1)*CF.A(M.R(15+2000*M.C(WingSine/92)),0,M.R(-45-9*M.C(WingSine/32))),.2)
...
WingAnims.StarLFR1=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(3.3,1,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(3.3,6,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(3.3,12,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(3.3,-6,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(3.3,-12,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(3.3,-18,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),7,M.R(-30-800*M.C(WingSine/50))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.StarLFR3=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-3.3,1,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-3.3,-6,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-3.3,6,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(3.3,1,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(3.3,-6,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(3.3,6,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),7,M.R(-30-800*M.C(WingSine/50))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(3.3,-12,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(-3.3,-12,0)*CF.A(M.R(120+3600*M.C(WingSine/200)),0,M.R(0)),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.Vehicle=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(.15,-2,-4)*CF.A(M.R(180+0*M.C(WingSine/32)),0,M.R(90)),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.1,-3.7,2)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(90)),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-.8,-1.8,-4)*CF.A(M.R(180+0*M.C(WingSine/32)),0,M.R(90)),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.15,-2,1.75)*CF.A(M.R(180+0*M.C(WingSine/32)),0,M.R(-90)),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.1,-3.7,2)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(-90)),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-3,-1.8,-1.8)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-90)),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-0,-3,1)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(-0-0*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-.0,0,-1.8)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-180)),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(-.0,-1.3,1.7)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-180)),.2)
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.StarLOS=function()
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-25.5,.5,-1)*CF.A(M.R(20+30*M.C(WingSine/32)),0,M.R(-40-45*M.C(WingSine/32))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(25,.5,-1)*CF.A(M.R(20+30*M.C(WingSine/32)),0,M.R(40+45*M.C(WingSine/32))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.NebDARY1=function(div)
	div=div or 1.5
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(0*M.C(WingSine/1),5+0*M.S(WingSine/1),-1)*CF.A(0,0,M.R(180-360*M.C(WingSine/32))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(0*M.C(WingSine/1),5+0*M.S(WingSine/1),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/110))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(1+5000*M.C(WingSine/550))),.2)
	 
    RWP1W.C0 = RWP1W.C0:lerp(CF.N(0*M.C(WingSine/32),5+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/255))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(0*M.C(WingSine/1),5+0*M.S(WingSine/1),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/110))),.2)
    RWP3W.C0 = RWP3W.C0:lerp(CF.N(0,5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(-180+5000*M.C(WingSine/550))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.Palactus=function(div)
    div=div or 1
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-3,3,-1)*CF.A(M.R(-0-6000*M.C(WingSine/322)),0,M.R(56)),.2)
    LWP2W.C0 = LWP2W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,2,M.R(0+5000*M.C(WingSine/200)))*CF.A(0,M.R(90),0)*CF.N(-5,0,0),.2)
    LWP3W.C0 = LWP3W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,2,M.R(-0-5000*M.C(WingSine/200)))*CF.A(0,M.R(90),0)*CF.N(-5,0,0),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(3,3,-1)*CF.A(M.R(-0-6000*M.C(WingSine/322)),0,M.R(-56)),.2)
    RWP2W.C0 = RWP2W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,2,M.R(0+5000*M.C(WingSine/200)))*CF.A(0,M.R(90),0)*CF.N(8,0,0),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,2,M.R(-0-5000*M.C(WingSine/200)))*CF.A(0,M.R(90),0)*CF.N(8,0,0),.2)
	...
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(1,7,2)*CF.A(0,M.R(0+2.5*M.C(WingSine/200)),M.R(90+5000*M.C(WingSine/400)))*CF.A(20.5,M.R(2),0)*CF.N(-0,4,0),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(1,7,2)*CF.A(0,M.R(0+2.5*M.C(WingSine/200)),M.R(-90-5000*M.C(WingSine/400)))*CF.A(20.5,M.R(2),0)*CF.N(-0,4,0),.2)
...
WingAnims.NebJEVIL=function(div)
	        ...
	        LWP2W.C0 = LWP2W.C0:lerp(CF.N(1,7,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(90+5000*M.C(WingSine/400)))*CF.A(20.5,M.R(2),0)*CF.N(-0,4,0),.2)
         	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-0*M.C(WingSine/1),5*M.C(WingSine/16),-1)*CF.A(100,2,M.R(-90-5000*M.C(WingSine/322)))*CF.A(20.5,M.R(2),0)*CF.N(-0,3,0),.2)
...
WingAnims.NebCALAMITAS1=function(div)
            div=div or 1
			LWP1W.C0 = LWP1W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(0+5000*M.C(WingSine/350))),.2)
	        LWP2W.C0 = LWP2W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(60+5000*M.C(WingSine/350))),.2)
	        LWP3W.C0 = LWP3W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(120+5000*M.C(WingSine/350))),.2)

			RWP1W.C0 = RWP1W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(180+5000*M.C(WingSine/350))),.2)
	        RWP2W.C0 = RWP2W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(240+5000*M.C(WingSine/350))),.2)
	        RWP3W.C0 = RWP3W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(300+5000*M.C(WingSine/350))),.2)
            RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	        RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	        RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	        RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.NebCALAMITASsmol=function(div)
    LWP1W.C0 = LWP1W.C0:lerp(CF.N(0,2+-6*M.C(WingSine/16),-2)*CF.A(0,M.R(-50+5*M.C(WingSine/39)),M.R(180+90*M.C(WingSine/10))),.2)
    LWP2W.C0 = LWP2W.C0:lerp(CF.N(0,2+-9*M.C(WingSine/16),-2)*CF.A(0,M.R(50+5*M.C(WingSine/39)),M.R(-180+90*M.C(WingSine/13))),.2)
    LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,2+-12*M.C(WingSine/16),-2)*CF.A(0,M.R(50+5*M.C(WingSine/39)),M.R(180+90*M.C(WingSine/15))),.2)
    
    RWP1W.C0 = RWP1W.C0:lerp(CF.N(0,2+-6*M.C(WingSine/16),-2)*CF.A(0,M.R(50+5*M.C(WingSine/39)),M.R(-180+90*M.C(WingSine/12))),.2)
    RWP2W.C0 = RWP2W.C0:lerp(CF.N(0,2+-9*M.C(WingSine/16),-2)*CF.A(0,M.R(50+5*M.C(WingSine/39)),M.R(180+90*M.C(WingSine/25))),.2)
    RWP3W.C0 = RWP3W.C0:lerp(CF.N(0,2+-12*M.C(WingSine/16),-2)*CF.A(0,M.R(50+5*M.C(WingSine/39)),M.R(180+90*M.C(WingSine/18))),.2)
...
WingAnims.THESTORM=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(3,1.5,-1)*CF.A(0,M.R(5+5*M.C(WingSine/32)),M.R(0+200*M.C(WingSine/5))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(3,5,-1)*CF.A(0,M.R(5-5*M.C(WingSine/32)),M.R(90+200*M.C(WingSine/5))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(6,8,-1)*CF.A(0,M.R(5+5*M.C(WingSine/32)),M.R(180+200*M.C(WingSine/5))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(3,1.5,-1)*CF.A(0,M.R(5+2.5*M.C(WingSine/32)),M.R(-0-200*M.C(WingSine/5))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(3,5,-1)*CF.A(0,M.R(5-7.5*M.C(WingSine/32)),M.R(-90-200*M.C(WingSine/5))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(6,8,-1)*CF.A(0,M.R(5+5*M.C(WingSine/32)),M.R(-180-200*M.C(WingSine/5))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(5,-0-3,-1)*CF.A(0,M.R(250+5*M.C(WingSine/39)),M.R(180+5000*M.C(WingSine/1000))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(5,-0-3,-1)*CF.A(0,M.R(250+5*M.C(WingSine/39)),M.R(-1+5000*M.C(WingSine/1000))),.2)
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.Crazed=function()
  	LWP1W.C0 = LWP1W.C0:lerp(CF.N(10,-2,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0+15*M.C(WingSine/32))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(20,-1,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(10+25*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(30,.5,-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(30+30*M.C(WingSine/32))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-10,-2,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0-15*M.C(WingSine/32))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-20.5,-1,-1+.05*M.S(WingSine/35))*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-10-25*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-30,.5,-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(-30-30*M.C(WingSine/32))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-4,.5,-1)*CF.A(M.R(5+0*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-40,.5,-1)*CF.A(M.R(20+30*M.C(WingSine/32)),0,M.R(-40-45*M.C(WingSine/32))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(40,.5,-1)*CF.A(M.R(20+30*M.C(WingSine/32)),0,M.R(40+45*M.C(WingSine/32))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.SHATTERX=function()
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-3)*CF.A(-1.5,0,M.R(-0-0*M.C(WingSine/402))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(4,5,-15)*CF.A(M.R(0+7920*M.C(WingSine/200)),0,M.R(90)),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(-4,5,-15)*CF.A(M.R(0-7920*M.C(WingSine/200)),0,M.R(90)),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/16),-1.64+0*M.S(WingSine/16),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
end
...
WingAnims.CERTUS3=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(3.2*M.C(WingSine/42),1.5*M.S(WingSine/42),0)*CF.A(0.1,0,M.R(100+10*M.C(WingSine/22))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(3.2*M.C(WingSine/42),1.5*M.C(WingSine/42),0)*CF.A(0.1,0,M.R(90+10*M.C(WingSine/22))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(3.2*M.C(WingSine/32),1.5*M.S(WingSine/42),2)*CF.A(0.1,0,M.R(190+200*M.C(WingSine/78))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-3.2*M.C(WingSine/42),1.5*M.C(WingSine/42),0)*CF.A(0.1,0,M.R(-100-10*M.C(WingSine/22))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-3.2*M.C(WingSine/42),1.5*M.S(WingSine/42),0)*CF.A(0.1,0,M.R(-90-10*M.C(WingSine/22))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-3.2*M.C(WingSine/32),1.5*M.S(WingSine/42),2)*CF.A(0.1,0,M.R(190-200*M.C(WingSine/78))),.2)
...
WingAnims.StarGASTER=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(0,-15,-1+1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/1))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(9.25,-10,-1-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(15+5*M.C(WingSine/2))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(12.5,.5,-1+1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(30+5*M.C(WingSine/1))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-9.25,-10,-1-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-15-5*M.C(WingSine/2))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(0,-7,-1-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/2))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-11.5,.5,-1+1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(-30-5*M.C(WingSine/1))),.2)
  	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-6,-2,-1-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-15-5*M.C(WingSine/2))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(6,-2,-1-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(15+5*M.C(WingSine/2))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.PUNK=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(6*M.C(WingSine/12),-1.5+.7*M.S(WingSine/12),1)*CF.A(M.R(5+2*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(6*M.C(WingSine/22),-3.5+.7*M.S(WingSine/12),-4)*CF.A(M.R(10+2*M.C(WingSine/32)),0,M.R(15+7.5*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(6*M.C(WingSine/22),-5.5+.7*M.S(WingSine/12),3)*CF.A(M.R(5+2*M.C(WingSine/16)),0,M.R(0+9*M.C(WingSine/16))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-6*M.C(WingSine/12),-1.5+.7*M.S(WingSine/12),1)*CF.A(M.R(5+2*M.C(WingSine/32)),0,M.R(0-5*M.C(WingSine/32))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-6*M.C(WingSine/22),-3.5+.7*M.S(WingSine/12),-4)*CF.A(M.R(10+2*M.C(WingSine/32)),0,M.R(-15-7.5*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-6*M.C(WingSine/22),-5.5+.7*M.S(WingSine/12),3)*CF.A(M.R(5+2*M.C(WingSine/16)),0,M.R(0-9*M.C(WingSine/16))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-0,0,-3)*CF.A(M.R(-90+90000*M.C(WingSine/200000000000000000000000000999999999999999999000000999900000099999999)),0,M.R(-0)),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-10*M.C(WingSine/32),0.25*M.C(WingSine/32),0)*CF.A(0,0,M.R(5.5*M.C(WingSine/32))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(10*M.C(WingSine/32),0.25*M.C(WingSine/32),0)*CF.A(0,0,M.R(5.5*M.C(WingSine/32))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.StarLEP1=function()
	...
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-12.5,.5,-1)*CF.A(M.R(15+400*M.C(WingSine/32)),0,M.R(-30-9*M.C(WingSine/32))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-16,-1,-1+.05*M.S(WingSine/35))*CF.A(M.R(10+350*M.C(WingSine/32)),0,M.R(-30-9*M.C(WingSine/32))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(16,-1,-1)*CF.A(M.R(10+350*M.C(WingSine/32)),0,M.R(30+9*M.C(WingSine/32))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.GALACTUS=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(0*M.C(WingSine/32),6+0*M.S(WingSine/32),-1)*CF.A(0,0,M.R(60-360*M.C(WingSine/50))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(0*M.C(WingSine/32),6+0*M.C(WingSine/32),-1)*CF.A(0,0,M.R(120-360*M.C(WingSine/50))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0*M.C(WingSine/32),6+0*M.S(WingSine/32),-1)*CF.A(0,0,M.R(180-360*M.C(WingSine/50))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(0*M.C(WingSine/32),6+0*M.C(WingSine/32),-1)*CF.A(0,0,M.R(240-360*M.C(WingSine/50))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(0*M.C(WingSine/32),6+0*M.S(WingSine/32),-1)*CF.A(0,0,M.R(300-360*M.C(WingSine/50))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(0*M.C(WingSine/32),6+0*M.S(WingSine/32),-1)*CF.A(0,0,M.R(360-360*M.C(WingSine/50))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.GALACTUSA=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(.15*M.C(WingSine/32),7+.5*M.S(WingSine/32),-1)*CF.A(0,0,M.R(60+5*M.C(WingSine/32))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.1*M.C(WingSine/32),5+.5*M.C(WingSine/32),-1)*CF.A(0,0,M.R(1+2.5*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25*M.C(WingSine/32),7-.5*M.S(WingSine/32),-1)*CF.A(0,0,M.R(120+5*M.C(WingSine/32))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.15*M.C(WingSine/32),7-.5*M.C(WingSine/32),-1)*CF.A(0,0,M.R(-60+5*M.C(WingSine/32))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.1*M.C(WingSine/32),5+.5*M.S(WingSine/32),-1)*CF.A(0,0,M.R(-180+2.5*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25*M.C(WingSine/32),7+.5*M.S(WingSine/32),-1)*CF.A(0,0,M.R(-120+5*M.C(WingSine/32))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/16),-1.64+0*M.S(WingSine/16),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
...
WingAnims.besmirch=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-.01*M.C(WingSine/32),3.5-3*M.C(WingSine/21),0)*CF.A(M.R(60),0,M.R(140)),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-.01*M.C(WingSine/32),3-2.5*M.C(WingSine/21),0)*CF.A(M.R(40),0,M.R(130)),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-.01*M.C(WingSine/32),2.5-2*M.C(WingSine/21),-0)*CF.A(M.R(20),0,M.R(120)),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.01*M.C(WingSine/32),3.5-3*M.C(WingSine/21),0)*CF.A(M.R(60),0,M.R(-140)),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.01*M.C(WingSine/32),3-2.5*M.C(WingSine/21),0)*CF.A(M.R(40),0,M.R(-130)),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.01*M.C(WingSine/32),2.5-2*M.C(WingSine/21),0)*CF.A(M.R(20),0,M.R(-120)),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/16),-1.64+0*M.S(WingSine/16),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
...
WingAnims.RushALL=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(.15*M.C(WingSine/15),4+3*M.S(WingSine/4),-1)*CF.A(0.2,0,M.R(120+5*M.C(WingSine/15))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.1*M.C(WingSine/15),4+3*M.S(WingSine/3.5),-1)*CF.A(0.2,0,M.R(90+5*M.C(WingSine/15))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25*M.C(WingSine/15),4+3*M.S(WingSine/3),-1)*CF.A(0.2,0,M.R(150-5*M.C(WingSine/15))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.15*M.C(WingSine/15),4-3*M.S(WingSine/4),-1)*CF.A(0.2,0,M.R(-120-5*M.C(WingSine/15))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.1*M.C(WingSine/15),4-3*M.S(WingSine/3.5),-1)*CF.A(0.2,0,M.R(-90-5*M.C(WingSine/15))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25*M.C(WingSine/15),4-3*M.S(WingSine/3),-1)*CF.A(0.2,0,M.R(-150+5*M.C(WingSine/15))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-.25*M.C(WingSine/15),4-3*M.S(WingSine/2.5),-1)*CF.A(0.2,0,M.R(-60+5*M.C(WingSine/15))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(.25*M.C(WingSine/15),4+3*M.S(WingSine/2.5),-1)*CF.A(0.2,0,M.R(60-5*M.C(WingSine/15))),.2)
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/16),-1.64+0*M.S(WingSine/16),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
end

WingAnims.RushALL1=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(.15*M.C(WingSine/15),4+3*M.S(WingSine/6),-1)*CF.A(0,0,M.R(120+5*M.C(WingSine/15))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.1*M.C(WingSine/15),4+3*M.S(WingSine/5.5),-1)*CF.A(0,0,M.R(90+5*M.C(WingSine/15))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25*M.C(WingSine/15),4+3*M.S(WingSine/5),-1)*CF.A(0,0,M.R(150-5*M.C(WingSine/15))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.15*M.C(WingSine/15),4-3*M.S(WingSine/6.5),-1)*CF.A(0,0,M.R(-120-5*M.C(WingSine/15))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.1*M.C(WingSine/15),4-3*M.S(WingSine/7.5),-1)*CF.A(0,0,M.R(-90-5*M.C(WingSine/15))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25*M.C(WingSine/15),4-3*M.S(WingSine/7),-1)*CF.A(0,0,M.R(-150+5*M.C(WingSine/15))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/16),-1.64+0*M.S(WingSine/16),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
...
WingAnims.RushALL2=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(.15*M.C(WingSine/15),1.5+3*M.S(WingSine/6),-1)*CF.A(0,0,M.R(120+5*M.C(WingSine/15))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.1*M.C(WingSine/15),2+3*M.C(WingSine/5.5),-1)*CF.A(0,0,M.R(90+2.5*M.C(WingSine/15))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25*M.C(WingSine/15),2.5-3*M.S(WingSine/5),-1)*CF.A(0,0,M.R(150-5*M.C(WingSine/15))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.15*M.C(WingSine/15),3-3*M.C(WingSine/6.5),-1)*CF.A(0,0,M.R(-120-5*M.C(WingSine/15))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.1*M.C(WingSine/15),3.5+3*M.S(WingSine/7.5),-1)*CF.A(0,0,M.R(-90-2.5*M.C(WingSine/15))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25*M.C(WingSine/15),4+3*M.S(WingSine/7),-1)*CF.A(0,0,M.R(-150+5*M.C(WingSine/15))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
...
WingAnims.StarA=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(0*M.C(WingSine/32),3+0*M.S(WingSine/32),-3)*CF.A(0,0,M.R(0-360*M.C(WingSine/50))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(0*M.C(WingSine/32),3+0*M.S(WingSine/32),-3)*CF.A(0,0,M.R(120-360*M.C(WingSine/50))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0*M.C(WingSine/32),3+0*M.S(WingSine/32),-3)*CF.A(0,0,M.R(-120-360*M.C(WingSine/50))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(0*M.C(WingSine/32),6+0*M.S(WingSine/32),-7)*CF.A(0,0,M.R(0-500*M.C(WingSine/50))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(0*M.C(WingSine/32),6+0*M.S(WingSine/32),-7)*CF.A(0,0,M.R(120-500*M.C(WingSine/50))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(0*M.C(WingSine/32),6+0*M.S(WingSine/32),-7)*CF.A(0,0,M.R(-120-500*M.C(WingSine/50))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/32),9+0*M.S(WingSine/32),-12)*CF.A(0,0,M.R(90-1050*M.C(WingSine/50))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/32),9+0*M.C(WingSine/32),-12)*CF.A(0,0,M.R(180-1050*M.C(WingSine/50))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),9+0*M.S(WingSine/32),-12)*CF.A(0,0,M.R(270-1050*M.C(WingSine/50))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/32),9+0*M.S(WingSine/32),-12)*CF.A(0,0,M.R(360-1050*M.C(WingSine/50))),.2)		
end
...
WingAnims.Shatter=function()
	...
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-0+0*M.C(WingSine/90),6,4)*CF.A(M.R(120+-6000*M.C(WingSine/322)),10,M.R(0-720*M.C(WingSine/200))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-1.8,7,-2)*CF.A(M.R(0+6000*M.C(WingSine/160)),0,M.R(90)),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-1.8,7,-2)*CF.A(M.R(170+6000*M.C(WingSine/160)),0,M.R(90)),.2)
    RWP3W.C0 = RWP3W.C0:lerp(CF.N(-0+0*M.C(WingSine/90),6,4)*CF.A(M.R(240+-6000*M.C(WingSine/322)),10,M.R(0-720*M.C(WingSine/200))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-3)*CF.A(M.R(15+0*M.C(WingSine/21)),0,M.R(-100-2*M.C(WingSine/192))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/21),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(-0+0*M.C(WingSine/90),6,4)*CF.A(M.R(0+-6000*M.C(WingSine/322)),10,M.R(10-720*M.C(WingSine/200))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/21),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.THEEXPURGATIONHASCOME=function()
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-3)*CF.A(M.R(15+0*M.C(WingSine/21)),0,M.R(-100-2*M.C(WingSine/192))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,0,5)*CF.A(M.R(360-6000*M.C(WingSine/322)),0,M.R(180)),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,0,5)*CF.A(M.R(360+6000*M.C(WingSine/322)),0,M.R(-180)),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/21),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end


WingAnims.StarELE=function()
	...
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-8*M.C(WingSine/32),-3)*CF.A(90,5,M.R(-270-320*M.C(WingSine/250))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-8*M.C(WingSine/32),-3)*CF.A(90,5,M.R(-30-320*M.C(WingSine/250))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.FEARLESS=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-8)*CF.A(0,1,M.R(-150+4610*M.C(WingSine/290))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-7)*CF.A(0,1,M.R(-180-2045*M.C(WingSine/290))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-6)*CF.A(0,1,M.R(-210+3200*M.C(WingSine/290))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-5)*CF.A(0,1,M.R(-60-2750*M.C(WingSine/290))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-4)*CF.A(0,1,M.R(-90+1500*M.C(WingSine/290))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-3)*CF.A(0,1,M.R(-120-4300*M.C(WingSine/290))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-3)*CF.A(M.R(15+0*M.C(WingSine/32)),0,M.R(-100-2*M.C(WingSine/192))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-2)*CF.A(0,1,M.R(-270+2500*M.C(WingSine/290))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-1)*CF.A(0,1,M.R(-240-3200*M.C(WingSine/290))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-1)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.StarLTT1=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-3*M.C(WingSine/32),0.5-9*M.C(WingSine/24),-1)*CF.A(.25,0,M.R(-240-2000*M.C(WingSine/322))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-3*M.C(WingSine/32),0.5-9*M.C(WingSine/24),-1)*CF.A(.25,0,M.R(-300-2000*M.C(WingSine/322))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-3*M.C(WingSine/32),0.5-9*M.C(WingSine/24),-1)*CF.A(.25,0,M.R(-360-2000*M.C(WingSine/322))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-3*M.C(WingSine/32),0.5-9*M.C(WingSine/24),-1)*CF.A(.25,0,M.R(-60-2000*M.C(WingSine/322))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-3*M.C(WingSine/32),0.5-9*M.C(WingSine/24),-1)*CF.A(.25,0,M.R(-120-2000*M.C(WingSine/322))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-3*M.C(WingSine/32),0.5-9*M.C(WingSine/24),-1)*CF.A(.25,0,M.R(-180-2000*M.C(WingSine/322))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-0,.5,-2)*CF.A(M.R(15+2*M.C(WingSine/24)),0,M.R(-30-900*M.C(WingSine/192))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(.25,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(.25,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.HOWDOIDOTHIS1=function()
--LWP1W.C0 = LWP1W.C0:lerp(CF.N(-8*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-150-2000*M.C(WingSine/322))),.2)
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-240-4000*M.C(WingSine/322))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-300-4000*M.C(WingSine/322))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-360-4000*M.C(WingSine/322))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-60-4000*M.C(WingSine/322))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-120-4000*M.C(WingSine/322))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-180-4000*M.C(WingSine/322))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-0,.5,-2)*CF.A(M.R(15+2*M.C(WingSine/24)),0,M.R(-30-900*M.C(WingSine/192))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(.50,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(.50,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.HOWDOIDOTHIS=function()
--LWP1W.C0 = LWP1W.C0:lerp(CF.N(-8*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-150-2000*M.C(WingSine/322))),.2)
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-240-2000*M.C(WingSine/322))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-300-2000*M.C(WingSine/322))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-360-2000*M.C(WingSine/322))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-60-2000*M.C(WingSine/322))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-120-2000*M.C(WingSine/322))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(8*M.C(WingSine/32),0.5+-9*M.C(WingSine/24),-8)*CF.A(.25,1.25,M.R(-180-2000*M.C(WingSine/322))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-0,.5,-2)*CF.A(M.R(15+2*M.C(WingSine/24)),0,M.R(-30-900*M.C(WingSine/192))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(.50,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(.50,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.TASTEMYSWORDS2=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(1*M.C(WingSine/32),2.5+2*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(80-200*M.C(WingSine/104))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(2*M.C(WingSine/32),2.5+3*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(90+200*M.C(WingSine/104))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(3*M.C(WingSine/32),2.5+4*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(120-200*M.C(WingSine/104))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-1*M.C(WingSine/32),2.5+2*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-80+200*M.C(WingSine/104))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-2*M.C(WingSine/32),2.5+3*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-90-200*M.C(WingSine/104))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-3*M.C(WingSine/32),2.5+4*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-120+200*M.C(WingSine/104))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/6),-1.80+0*M.S(WingSine/6),-2)*CF.A(0,0,M.R(-0-2000*M.C(WingSine/80))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-3*M.C(WingSine/32),2+5*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-40+200*M.C(WingSine/104))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(3*M.C(WingSine/32),2+5*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(40-200*M.C(WingSine/104))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.TASTEMYSWORDS=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(1*M.C(WingSine/32),2.5+2*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(80-200*M.C(WingSine/104))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(2*M.C(WingSine/32),3.5+3*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(100+200*M.C(WingSine/104))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(3*M.C(WingSine/32),4.5+4*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(140-200*M.C(WingSine/104))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-1*M.C(WingSine/32),2.5+2*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-80+200*M.C(WingSine/104))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-2*M.C(WingSine/32),3.5+3*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-100-200*M.C(WingSine/104))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-3*M.C(WingSine/32),4.5+4*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-140+200*M.C(WingSine/104))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/6),-1.80+0*M.S(WingSine/6),-2)*CF.A(0,0,M.R(-0-2000*M.C(WingSine/80))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-4*M.C(WingSine/32),5.5+5*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-40+200*M.C(WingSine/104))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(4*M.C(WingSine/32),5.5+5*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(40-200*M.C(WingSine/104))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.StarLOXD1=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(6*M.C(WingSine/32),1.5+.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(0+150*M.C(WingSine/62))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(8*M.C(WingSine/32),1.5+.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(90+150*M.C(WingSine/62))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(10*M.C(WingSine/32),1.5+.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(180+150*M.C(WingSine/62))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(-0-150*M.C(WingSine/62))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-8*M.C(WingSine/32),1.5-.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(-90-150*M.C(WingSine/62))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-10*M.C(WingSine/32),1.5-.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(-180-150*M.C(WingSine/62))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-8*M.C(WingSine/32),1.5-.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(-270-150*M.C(WingSine/62))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(8*M.C(WingSine/32),1.5+.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(270+150*M.C(WingSine/62))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)		
end

WingAnims.StarLOXD2=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(6*M.C(WingSine/8),1.5+.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(0+150*M.C(WingSine/16))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(8*M.C(WingSine/8),1.5+.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(90+150*M.C(WingSine/16))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(10*M.C(WingSine/8),1.5+.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(180+150*M.C(WingSine/16))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-6*M.C(WingSine/8),1.5-.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(-0-150*M.C(WingSine/16))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-8*M.C(WingSine/8),1.5-.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(-90-150*M.C(WingSine/16))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-10*M.C(WingSine/8),1.5-.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(-180-150*M.C(WingSine/4))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-8*M.C(WingSine/8),1.5-.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(-270-150*M.C(WingSine/16))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(8*M.C(WingSine/8),1.5+.1*M.C(WingSine/61),-1)*CF.A(0.4,0,M.R(270+150*M.C(WingSine/16))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)		
end
...
WingAnims.SONUS3B=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-1)*CF.A(0,1,M.R(-120-3200*M.C(WingSine/290))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-1)*CF.A(0,1,M.R(-210-3200*M.C(WingSine/290))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-10)*CF.A(0,1,M.R(-270-3200*M.C(WingSine/290))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-10)*CF.A(0,1,M.R(-90-3200*M.C(WingSine/290))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-10)*CF.A(0,1,M.R(-150-3200*M.C(WingSine/290))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-10)*CF.A(0,1,M.R(-210-3200*M.C(WingSine/290))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
...
WingAnims.really=function()
    ...
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-800*M.C(WingSine/120))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-2*M.C(WingSine/32),1.5-.1*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-260-45*M.C(WingSine/12))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(2*M.C(WingSine/32),1.5+.1*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(260+45*M.C(WingSine/12))),.2)
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.StarTER=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(6*M.C(WingSine/12),-1.5+.7*M.S(WingSine/12),1)*CF.A(M.R(5+2*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(6*M.C(WingSine/22),-3.5+.7*M.S(WingSine/12),-4)*CF.A(M.R(10+2*M.C(WingSine/32)),0,M.R(15+7.5*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(8.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(30+800*M.C(WingSine/32))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-6*M.C(WingSine/12),-1.5+.7*M.S(WingSine/12),1)*CF.A(M.R(5+2*M.C(WingSine/32)),0,M.R(0-5*M.C(WingSine/32))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-6*M.C(WingSine/22),-3.5+.7*M.S(WingSine/12),-4)*CF.A(M.R(10+2*M.C(WingSine/32)),0,M.R(-15-7.5*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-8.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-800*M.C(WingSine/32))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.BigMan=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(.15,500,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(60)),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.1,500,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(90)),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25,500,-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(120)),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.15,500,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(-60)),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.1,500,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-90)),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25,500,-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(-120)),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,0,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-0-5000*M.C(WingSine/192))),.2)
...
WingAnims.Hell2=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-0+0*M.C(WingSine/90),12,12)*CF.A(M.R(0+-6000*M.C(WingSine/322)),10,M.R(10-720*M.C(WingSine/200))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-0+0*M.C(WingSine/90),12,12)*CF.A(M.R(120+-6000*M.C(WingSine/322)),10,M.R(10-720*M.C(WingSine/200))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-0+0*M.C(WingSine/90),12,12)*CF.A(M.R(240+-6000*M.C(WingSine/322)),10,M.R(10-720*M.C(WingSine/200))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-0+0*M.C(WingSine/90),12,12)*CF.A(M.R(0+-6000*M.C(WingSine/322)),10,M.R(10-720*M.C(WingSine/200))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-0+0*M.C(WingSine/90),12,12)*CF.A(M.R(60+-6000*M.C(WingSine/322)),10,M.R(10-720*M.C(WingSine/200))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-0+0*M.C(WingSine/90),12,12)*CF.A(M.R(180+-6000*M.C(WingSine/322)),10,M.R(10-720*M.C(WingSine/200))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.StarLOXD=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(4*M.C(WingSine/32),1.5+.1*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(0+45*M.C(WingSine/12))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(6*M.C(WingSine/32),1+.1*M.C(WingSine/32),-1)*CF.A(0.2,0,M.R(90+45*M.C(WingSine/12))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(8*M.C(WingSine/32),.5+.1*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(180+45*M.C(WingSine/12))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-4*M.C(WingSine/32),1.5-.1*M.C(WingSine/32),-1)*CF.A(0.2,0,M.R(-0-45*M.C(WingSine/12))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-6*M.C(WingSine/32),1+.1*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-90-45*M.C(WingSine/12))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-8*M.C(WingSine/32),.5+.1*M.S(WingSine/32),-1)*CF.A(0.2,0,M.R(-180-45*M.C(WingSine/12))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-7*M.C(WingSine/32),1.5+1*M.S(WingSine/42),-1)*CF.A(0.2,-0.1,M.R(-270-45*M.C(WingSine/12))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(7*M.C(WingSine/32),1.5+1*M.C(WingSine/42),-1)*CF.A(0.2,0.1,M.R(270+45*M.C(WingSine/12))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)		
end

WingAnims.StarXD=function()
    LWP1W.C0 = LWP1W.C0:lerp(CF.N(0,2+-6*M.C(WingSine/16),-2)*CF.A(-32,M.R(0+2.5*M.C(WingSine/36)),M.R(600+5000*M.C(WingSine/400))),.2)
    LWP2W.C0 = LWP2W.C0:lerp(CF.N(0,2+-6*M.C(WingSine/16),-2)*CF.A(-32,M.R(0+7.5*M.C(WingSine/32)),M.R(1200+5000*M.C(WingSine/400))),.2)
    LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,1,-0)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(1200+5000*M.C(WingSine/400))),.2)
	
    RWP1W.C0 = RWP1W.C0:lerp(CF.N(0,2+-6*M.C(WingSine/16),-2)*CF.A(-32,M.R(0+2.5*M.C(WingSine/36)),M.R(1800+5000*M.C(WingSine/400))),.2)
    RWP2W.C0 = RWP2W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
    RWP3W.C0 = RWP3W.C0:lerp(CF.N(0,1,-0)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(-120+5000*M.C(WingSine/400))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-800*M.C(WingSine/120))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(50,50,50)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(30+9*M.C(WingSine/32))),.2)  
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,1,-0)*CF.A(-0,M.R(0+5*M.C(WingSine/32)),M.R(12+5000*M.C(WingSine/400))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)			
end

WingAnims.MANGYR=function(div)
	  div=div or 1
	  ...
	  LWP3W.C0 = LWP3W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(0+5000*M.C(WingSine/200))),.2)
      ...
      RWP3W.C0 = RWP3W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(180+5000*M.C(WingSine/200))),.2)
      RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
      RWP5W.C0 = RWP5W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(-90+5000*M.C(WingSine/200))),.2)
      RWP6W.C0 = RWP6W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(90+5000*M.C(WingSine/200))),.2)
      RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
   end

WingAnims.MANGYT=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(4.15,1.5,-5)*CF.A(M.R(50+15555*M.C(WingSine/1400)),0,M.R(30)),.7)
	...
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-4.15,1.5,-5)*CF.A(M.R(50+15555*M.C(WingSine/1400)),0,M.R(-30)),.7)
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-.1,2.5,-3)*CF.A(M.R(10+300*M.C(WingSine/23)),0,M.R(-60)),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(.1,2.5,-3)*CF.A(M.R(10+300*M.C(WingSine/23)),0,M.R(60)),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.NebG6=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(.15,12,-1)*CF.A(M.R(122+100*M.C(WingSine/322)),-180,M.R(60)),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.1,10,-1)*CF.A(M.R(122+100*M.C(WingSine/342)),-180,M.R(90)),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25,8,-1)*CF.A(M.R(122+100*M.C(WingSine/320)),-180,M.R(120)),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.15,12,-1)*CF.A(M.R(122+100*M.C(WingSine/322)),180,M.R(-60)),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.1,10,-1)*CF.A(M.R(122+100*M.C(WingSine/342)),180,M.R(-90)),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25,8,-1)*CF.A(M.R(122+100*M.C(WingSine/320)),180,M.R(-120)),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
if(data.User==data.Local)then
	Player.Chatted:connect(function(m)
		...
		if(m:sub(1,5) == "play/")then
			getMode('TRIX-LUA').Music=Playlist[m:sub(6)] or tonumber(m:sub(6)) or 0
			music.SoundId="rbxassetid://"..getMode('TRIX-LUA').Music;
		...
		elseif(m:sub(1,6) == "pitch/")then
			...
			getMode('TRIX-LUA').Pitch=music.Pitch
		end
	end)
end
...
while true do
	...
	if(Mode=='TRIX-LUA' and IsVaporwave(getMode'TRIX-LUA'.Music))then
		...
		if(Mode=='TRIX-LUA')then
			text.Text='TRIX-LUA'
			WingAnim=getMode'TRIX-LUA'.WingAnim
		end
		vaporwaveMode=false
	end
	
	
		if(Mode~='HEROIC' and WingAnim and WingAnims[WingAnim])then
		WingAnims[WingAnim]()
	...
	if(Mode=='TRIX-LUA' and NeutralAnims)then
	...
	if(Mode=='TRIX-LUA' and data.User==data.Local)then
	...
	if(State == 'Idle')then
		if(Mode=='TRIX-LUA' and NeutralAnims and not vaporwaveMode)then Change = 0.1+music.PlaybackLoudness/200 else Change = 1 end
...
Lifetime = 0.2,
					...
					RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,2+.01*M.C(Sine/32),0)*CF.A(M.R(-30+3*M.S(Sine/64)),-0,0),Alpha)
					if(M.RNG(1,45)==1)then
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
				else
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),0,0),Alpha)
				end
					LS.C0 = LS.C0:lerp(LSC0*CF.N(0.5,1+.05*M.S(Sine/32),-0.5)*CF.A(260,M.R(5+5*M.C(Sine/32)),M.R(100-5*M.C(Sine/32))),Alpha)
					RS.C0 = RS.C0:lerp(RSC0*CF.N(-0.5,1+.05*M.S(Sine/32),-0.5)*CF.A(-280,M.R(7-6*M.C(Sine/32)),M.R(-100+5*M.C(Sine/32))),Alpha)
				end
				if(legAnims)then 
					if(NeutralAnims)then
...
Lifetime = 1,
			...
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(CF.N(0,3.8+1.2*M.C(Sine/54),0)*CF.A(M.R(-4+5*M.S(Sine/64)),M.R(.05),M.R(.05)),Alpha)
				NK.C0 = NK.C0:lerp(NKC0,Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.15*M.S(Sine/32),0)*CF.A(0,M.R(15+15*M.C(Sine/42)),M.R(-15-10*M.C(Sine/42))),Alpha)
				RS.C0 = RS.C0:lerp(LSC0*CF.N(3,-0.4+0.1*M.S(Sine/32),-.5)*CF.A(M.R(15-0*M.C(Sine/51)),M.R(-30-0*M.C(Sine/57)),M.R(190+0*M.C(Sine/46))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LH.C0 = LH.C0:lerp(LHC0*CF.N(0,.5,-.2)*CF.A(0,0,M.R(-5)),Alpha)
					RH.C0 = RH.C0:lerp(RHC0*CF.N(0,0-.05*M.C(Sine/302),0)*CF.A(M.R(-18),0,M.R(12)),Alpha)
				else
					LH.C0 = LH.C0:lerp(LHC0*CF.A(0,0,M.R(-2.5)),Alpha)
					RH.C0 = RH.C0:lerp(RHC0*CF.A(0,0,M.R(2.5)),Alpha)
				end
...
Lifetime = 0.2,
			...
			if(NeutralAnims)then
			RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,6+1*M.C(Sine/19),-0)*CF.A(M.R(2-5*M.S(Sine/18)),M.R(20+5*M.C(Sine/18)),0),Alpha)
		    NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(35),M.R(-10))*CF.A(M.RRNG(-5,5),M.RRNG(-5,5),M.RRNG(-5,5)),Alpha)
...
elseif(Mode=='Inverse Reanimate')then
			local Alpha = .1
							local HCF = Root.CFrame * CF.N(math.random(-20,20),-4,(math.random(-20,20))) * CF.A(M.R(math.random(-20,20)),M.R(math.random(-20,20)),M.R(math.random(-20,20)))
Effect({
...
Lifetime = 0.2,
			...
			RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,6+1*M.C(Sine/19),-0)*CF.A(M.R(2-5*M.S(Sine/18)),M.R(20+5*M.C(Sine/18)),0),Alpha)
		    NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-35),M.R(10))*CF.A(M.RRNG(5,5),M.RRNG(5,5),M.RRNG(5,5)),Alpha)
		    LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-35-5*M.C(Sine/32))),Alpha)
...
elseif(Mode=='Dual Reanimate')then
			local Alpha = .1
			local HCF = Root.CFrame * CF.N(math.random(-20,20),-4,(math.random(-20,20))) * CF.A(M.R(math.random(-20,20)),M.R(math.random(-20,20)),M.R(math.random(-20,20)))
Effect({
Color = BrickColor.new'Black'.Color;
...
Lifetime = 0.2,
			...
			if(NeutralAnims)then	
				...
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(1.6,M.R(5+5*M.C(Sine/32)),M.R(-0-0*M.C(Sine/32))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(1.6,M.R(5-5*M.C(Sine/32)),M.R(0+0*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LH.C0 = LH.C0:lerp(RHC0*CF.N(-1,1-0*M.C(Sine/32),-.75)*CF.A(1,M.R(-.01),0),Alpha)
					RH.C0 = RH.C0:lerp(RHC0*CF.N(0,1-0*M.C(Sine/32),-.75)*CF.A(1,M.R(-.01),0),Alpha)
				else
					LH.C0 = LH.C0:lerp(LHC0,Alpha)
					RH.C0 = RH.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.5+4.5*M.C(Sine/26),5+4.5*M.C(Sine/26),0)*CF.A(M.R(0+1*M.S(Sine/64)),0,0),Alpha)
				if(M.RNG(1,45)==1)then
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
				else
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),0,0),Alpha)
...
Lifetime = 0.2,
			...
			if(NeutralAnims)then	
				...
				LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),.1)*CF.A(M.R(-40),M.R(0+2.5*M.C(Sine/32)),M.R(0-1.5*M.C(Sine/32))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),.1)*CF.A(M.R(-40),M.R(0-2.5*M.C(Sine/32)),M.R(-0+1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LH.C0 = LH.C0:lerp(LHC0*CF.N(0,.5,-.2)*CF.A(0,0,M.R(-5)),Alpha)
		...
		elseif(Mode=='ULTRA SANS')then
			...
			if(NeutralAnims)then	
				...
				LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+1*M.S(Sine/7),0)*CF.A(2,2,M.R(-15+90*M.S(Sine/20))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(0,0+1*M.S(Sine/7),0)*CF.A(2,2,M.R(15-90*M.S(Sine/20))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LH.C0 = LH.C0:lerp(RHC0*CF.N(-1,0-1*M.C(Sine/7),0)*CF.A(.4,-1,M.R(-5),0),Alpha)
					RH.C0 = RH.C0:lerp(RHC0*CF.N(0,0-1*M.C(Sine/7),0)*CF.A(-.4,1,M.R(-5),0),Alpha)
				else
					LH.C0 = LH.C0:lerp(LHC0,Alpha)
					RH.C0 = RH.C0:lerp(RHC0,Alpha)
				end
...
if(legAnims)then 
	...
	local Alpha = .1
			...
			GotEffect{
				...
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,1+0*M.C(Sine/32),0)*CF.A(M.R(-25+1*M.S(Sine/18)),0,0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0,Alpha)
...
Lifetime = 0.25,
					...
					RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,7+.4*M.C(Sine/39),-0)*CF.A(M.R(2+.2*M.C(Sine/32)),M.R(20+5*M.C(Sine/24)),0),Alpha)
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
...
Lifetime = 0.2,
					...
					RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,6+2*M.C(Sine/16),0)*CF.A(M.R(0+3*M.S(Sine/64)),0,0),Alpha)
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
					LS.C0 = LS.C0:lerp(LSC0*CF.N(.3,0+.05*M.S(Sine/32),.1)*CF.A(M.R(-35),M.R(5+2.5*M.C(Sine/32)),M.R(-35-1.5*M.C(Sine/32))),Alpha)
...
Lifetime = 0.25,
				...
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.3+4*M.C(Sine/39),20+5*M.C(Sine/32),0)*CF.A(M.R(-2+7*M.S(Sine/58)),M.R(-15+3*M.C(Sine/42)),0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(15),0),Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.5,0+.05*M.S(Sine/32),-.6)*CF.A(M.R(-17),M.R(-20),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
...
Lifetime = 0.2,
			...
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,0+0.05*M.C(Sine/32),0)*CF.A(M.R(-0+0*M.S(Sine/58)),M.R(-15+0*M.C(Sine/42)),0),Alpha)
				if(M.RNG(1,25)==1)then
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
				else
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(35),M.R(-10))*CF.A(M.RRNG(-5,5),M.RRNG(-5,5),M.RRNG(-5,5)),Alpha)
...
if(legAnims)then 
			...
			if(legAnims)then 
				if(NeutralAnims)then
					...
					elseif(Mode=='SPACETIME X')then
			local Alpha = .1
			if(NeutralAnims)then	
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.3+4*M.C(Sine/39),13+4*M.C(Sine/32),0)*CF.A(M.R(-25+2*M.S(Sine/58)),M.R(0+4*M.C(Sine/42)),0),Alpha)
				if(M.RNG(1,25)==1)then
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
				else
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(35),M.R(-10))*CF.A(M.RRNG(-5,5),M.RRNG(-5,5),M.RRNG(-5,5)),Alpha)
...
Lifetime = 0.2,
				...
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0+1*M.C(Sine/49),4+2*M.C(Sine/42),0)*CF.A(M.R(-2+3*M.S(Sine/1)),M.R(-15+5*M.C(Sine/1)),0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0,Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.5,0+.05*M.S(Sine/32),-.6)*CF.A(M.R(-17),M.R(-20),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
			...
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.3+6*M.C(Sine/39),8+4*M.C(Sine/32),0)*CF.A(M.R(0+1*M.S(Sine/64)),M.R(5),0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.5,0+.05*M.S(Sine/32),-.6)*CF.A(M.R(-17),M.R(-20),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
		...
		elseif(Mode=='INFINITY')then
			...
			elseif(Mode=='ULTRABASS')then
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,0+0.05*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(5),0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-10*M.S(Sine/3)),M.R(-5),0),Alpha)
			    LS.C0 = LS.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.0,0+.1*M.S(Sine/32),.0)*CF.A(M.R(-180),M.R(5-2.5*M.C(Sine/32)),M.R(20+1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LH.C0 = LH.C0:lerp(LHC0*CF.N(0,0-.1*M.C(Sine/32),0),Alpha)
					RH.C0 = RH.C0:lerp(RHC0*CF.N(0,0-.2*M.C(Sine/4),0)*CF.A(0,M.R(-5),.3),Alpha)
				else
					LH.C0 = LH.C0:lerp(LHC0,Alpha)
					RH.C0 = RH.C0:lerp(RHC0,Alpha)
				end
...
if(legAnims)then 
			...
			if(legAnims)then 
				...
				elseif(Mode=='HERALD OF ILLUSION')then
				local Alpha = .1
				if(NeutralAnims)then	
...
if(legAnims)then 
	...
	elseif(Mode=='SHATTERED X')then
				local Alpha = .1
				if(NeutralAnims)then	
					RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,13+.6*M.C(Sine/26),-0)*CF.A(M.R(-2+5*M.S(Sine/32)),M.R(20+5*M.C(Sine/24)),0),Alpha)
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
					LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(-0.5,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
					RS.C0 = RS.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(-0.5,M.R(5-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
				end
	...
	local Alpha = .1
				if(NeutralAnims)then	
				Effect({
Color = BrickColor.new'Br. yellowish orange'.Color;
Material = Enum.Material.Neon,
Mesh = "Slash1",
CFrame = Root.CFrame* CF.N(0,-3,0) * CF.A(0,M.R(math.random(-180,180)),0),
EndPos = Root.CFrame* CF.N(0,-3,0) * CF.A(0,M.R(math.random(-180,180)),0),
...
Lifetime = .01,
	...
	elseif(Mode=='N U C L E A R  X')then
			local Alpha = .1
			if(NeutralAnims)then
			    				GotEffect{
					Lifetime=.5;
...
elseif(Mode=='THE PLAGUEBRINGER')then
				local Alpha = .1
			if(NeutralAnims)then
			local HCF = Root.CFrame * CF.N(math.random(-20,20),-4,(math.random(-20,20))) * CF.A(M.R(math.random(-20,20)),M.R(math.random(-20,20)),M.R(math.random(-20,20)))
Effect({
...
Lifetime = 0.25,
				...
				GotEffect{
					...
					Mesh={Type=Enum.MeshType.Sphere};
					CFrame=RArm.CFrame*CF.N(0,-1,0)*CF.A(M.RRNG(0,360),M.RRNG(0,360),M.RRNG(0,360));
					Color=BrickColor.new'Earth green'.Color;
					Transparency={0,1};
					Material=Enum.Material.Neon;
					Size=Vector3.new(.5,1,.5);
					EndSize=Vector3.new(.1,3,.1);
				}
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,7+0.4*M.C(Sine/32),0)*CF.A(M.R(0+3*M.S(Sine/64)),0,0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),0,0),Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(.0,-.0+.0*M.S(Sine/32),-.0)*CF.A(M.R(0),M.R(2),M.R(-40-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.0,0+.1*M.S(Sine/32),.0)*CF.A(M.R(-180),M.R(5-2.5*M.C(Sine/32)),M.R(20+1.5*M.C(Sine/32))),Alpha)
				if(legAnims)then
...
Lifetime = 0.2,
 				...
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,2+.01*M.C(Sine/32),0)*CF.A(M.R(-40+3*M.S(Sine/64)),-0,0),Alpha)
 				LS.C0 = LS.C0:lerp(LSC0*CF.N(0.5,1+.05*M.S(Sine/32),-0.5)*CF.A(260,M.R(5+5*M.C(Sine/32)),M.R(100-5*M.C(Sine/32))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-0.5,1+.05*M.S(Sine/32),-0.5)*CF.A(-280,M.R(7-6*M.C(Sine/32)),M.R(-100+5*M.C(Sine/32))),Alpha)
  				if(M.RNG(1,45)==1)then
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
		...
		if(Mode=='+OVERPOWERED+')then
			local Alpha = .1
  			if(NeutralAnims)then
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.3+.4*M.C(Sine/39),4+1*M.C(Sine/32),0)*CF.A(M.R(-56+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
 				LS.C0 = LS.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 1)*CF.A(-1,0,M.R(-7+5*M.S(Sine/32))),Alpha)
  				RS.C0 = RS.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(-1,0,M.R(7-5*M.S(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
...
Lifetime = 0.2,
		...
		if(Mode=='~Funky~')then
			local Alpha = .1
  			if(NeutralAnims)then
 			    RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,6+1*M.C(Sine/80),0)*CF.A(M.R(-90+2*M.S(Sine/32)),M.R(-0+999*M.C(Sine/80)),0),Alpha)
 				LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-90-5*M.C(Sine/32))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5-5*M.C(Sine/32)),M.R(90+5*M.C(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
...
elseif(State == 'Walk')then
		if(Mode=='SHATTERED X')then
			local Alpha = .1
				if(NeutralAnims)then
 		    		RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0+.4*M.C(Sine/39),13+.2*M.C(Sine/32),0)*CF.A(M.R(-56+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
 			    	LS.C0 = LS.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 1)*CF.A(-1,0,M.R(-7+5*M.S(Sine/32))),Alpha)
  			    	RS.C0 = RS.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(-1,0,M.R(7-5*M.S(Sine/32))),Alpha)
  			    	NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
				end
...
Lifetime = 0.25,
				...
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.3+4*M.C(Sine/39),20+5*M.C(Sine/32),0)*CF.A(M.R(-56+4*M.S(Sine/58)),M.R(0+4*M.C(Sine/42)),0),Alpha)
 				LS.C0 = LS.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 1)*CF.A(-1,0,M.R(-7+5*M.S(Sine/32))),Alpha)
  				RS.C0 = RS.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(-1,0,M.R(7-5*M.S(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
...
Lifetime = 0.2,
  			...
  			if(NeutralAnims)then
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.6+.4*M.C(Sine/39),3+1*M.C(Sine/32),0)*CF.A(M.R(-56+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
 				LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-90-5*M.C(Sine/32))),Alpha)
		        RS.C0 = RS.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(-1,0,M.R(7-5*M.S(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
			if(legAnims)then
			 ...
			 elseif(State == 'Walk')then
		if(Mode=='Inverse Reanimate')then
				local Alpha = .1
								local HCF = Root.CFrame * CF.N(math.random(-20,20),-4,(math.random(-20,20))) * CF.A(M.R(math.random(-20,20)),M.R(math.random(-20,20)),M.R(math.random(-20,20)))
Effect({
Color = BrickColor.new'White'.Color;
...
Lifetime = 0.25,
 		    	...
 		    	RJ.C0 = RJ.C0:lerp(RJC0*CF.N(7+.4*M.C(Sine/39),3+1*M.C(Sine/32),0)*CF.A(M.R(-15+5*M.S(Sine/58)),M.R(90+5*M.C(Sine/42)),0),Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(.0,-.0+.0*M.S(Sine/32),-.0)*CF.A(M.R(0),M.R(2),M.R(-20-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.0,0+.0*M.S(Sine/32),-.0)*CF.A(M.R(0),M.R(0),M.R(20+2*M.S(Sine/36))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
 ...
 elseif(State == 'Walk')then
	  ...
	  elseif(State == 'Walk')then
		...
		if(Mode=='GALACTIC')then
			...
			elseif(State == 'Walk')then
		if(Mode=='FEARLESS')then
			local wsVal = 4
			local Alpha = .1
  			if(NeutralAnims)then
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.3+6*M.C(Sine/39),8+4*M.C(Sine/32),0)*CF.A(M.R(-56+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
 				LS.C0 = LS.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 1)*CF.A(-1,0,M.R(-7+5*M.S(Sine/32))),Alpha)
  				RS.C0 = RS.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(-1,0,M.R(7-5*M.S(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
...
Lifetime = 2,
		...
		if(Mode=='INFERNO')then
			local Alpha = .1
  			if(NeutralAnims)then
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.5+4.5*M.C(Sine/26),5+4.5*M.C(Sine/26),0)*CF.A(M.R(-56+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
 				LS.C0 = LS.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 1)*CF.A(-1,0,M.R(-7+5*M.S(Sine/32))),Alpha)
  				RS.C0 = RS.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(-1,0,M.R(7-5*M.S(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
...
Lifetime = .02,
			...
			local Alpha = .2
			if(NeutralAnims)then
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,10+2*M.C(Sine/52),0)*CF.A(M.R(30+3*M.S(Sine/64)),0,0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(-28),0),Alpha)
 			    LS.C0 = LS.C0:lerp(LSC0*CF.N(.0,-.0+.0*M.S(Sine/32),-.0)*CF.A(M.R(0),M.R(2),M.R(-40-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(M.R(90+7.5*M.S(Sine/24)),M.R(19.2),M.R(0)),Alpha)
			end
			if(legAnims)then 
				...
				elseif(State == 'Walk')then
if(Mode=='HERALD OF ILLUSION')then
			local Alpha = .1
				if(NeutralAnims)then
...
elseif(State == 'Walk')then
		if(Mode=='THE PLAGUEBRINGER')then
				local Alpha = .1
  			if(NeutralAnims)then
			local HCF = Root.CFrame * CF.N(math.random(-20,20),-4,(math.random(-20,20))) * CF.A(M.R(math.random(-20,20)),M.R(math.random(-20,20)),M.R(math.random(-20,20)))
Effect({
             ...
             GotEffect{
			  ...
			  GotEffect{
				...
				GotEffect{
 				...
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.5+.4*M.C(Sine/39),4+.2*M.C(Sine/32),0)*CF.A(M.R(-56+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
 				LS.C0 = LS.C0:lerp(LSC0*CF.N(.0,-.0+.0*M.S(Sine/32),-.0)*CF.A(M.R(0),M.R(2),M.R(-40-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.0,0+.1*M.S(Sine/32),.0)*CF.A(M.R(-180),M.R(5-2.5*M.C(Sine/32)),M.R(20+1.5*M.C(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
...
fbutton.TextSize = 10.000
fbutton.MouseButton1Down:connect(function()
   changeMode'NEPTUNIAN V (UNEQUIPPED)'()
end)
